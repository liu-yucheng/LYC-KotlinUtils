...
class TermOutsDemo private constructor() {
    companion object {
        ...
        private fun setup() {
            Funcs.ensureAppData()
            Funcs.logln("- $packName TermOutsDemo logs")
            ...
            if (args.size > 0) {
                ...
                Funcs.logln("Usage: java -jar $jarName term-outs-demo", true)
        ...
        fun teardown() {
            ...
            Funcs.logln("- End $packName TermOutsDemo logs")
            Funcs.flushLogs()
            Funcs.closeLogs()
        } // end fun
        ...
        fun MainWin() {
            ...
            Window(
                ::exitDemo, States.mainWinState, true, "$packName $packVer TermOutsDemo",
