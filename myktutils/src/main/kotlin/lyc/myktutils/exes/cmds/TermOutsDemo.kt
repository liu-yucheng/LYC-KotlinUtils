...
import lyc.myktutils.libs.composeutils.envs.Elems
...
class TermOutsDemo private constructor() {
    companion object {
        ...
        private fun setup() {
            Funcs.ensureAppData()
            Funcs.logln("- liu-yucheng/MyKotlinUtils TermOutsDemo logs")

            if (args.size > 0) {
                Funcs.logln("TermOutsDemo gets invalid arguments", true)
                Funcs.logln("Usage: java -jar lyc-myktutils.jar term-outs-demo", true)
                Funcs.logln("Help: java -jar lyc-myktutils.jar help", true)
                Funcs.logln("- End liu-yucheng/MyKotlinUtils TermOutsDemo logs", true)
                Funcs.exitApp(1)
            } // end if
        ...
        fun teardown() {
            ...
            Funcs.logln("- End liu-yucheng/MyKotlinUtils TermOutsDemo logs")
        } // end fun
        ...
        fun MainWin() {
            ...
            Window(
                Funcs.Companion::exitApp, States.mainWinState, true, "TermOutsDemo",
                undecorated = false, transparent = false, resizable = true
            ) {
                Elems.AppFrame {
