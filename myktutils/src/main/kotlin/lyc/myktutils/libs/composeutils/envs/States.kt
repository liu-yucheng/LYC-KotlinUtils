...
import lyc.myktutils.libs.composeutils.FlatLafFuncs
import lyc.myktutils.libs.composeutils.Themes
...
class States private constructor() {
    companion object {
        ...
        /** All logs. */
        val allLogs = arrayListOf<Any>(System.out, termOuts, logWriter)
